  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <SwipeableDialogContent 
        ...
        className="sm:max-w-md bg-gradient-to-br from-white/95 via-white/90 to-[#CDB6EF]/20 dark:from-gray-900/95 dark:via-gray-900/90 dark:to-[#013DC4]/20 backdrop-blur-xl border-white/50 dark:border-white/10 rounded-3xl shadow-2xl shadow-[#013DC4]/10 p-5 mx-2" 
