...
const defaultMedications: MedicationProgress[] = [
  ...
  },
  {
    ...
    streak: 45,
    lastResetDate: new Date().toDateString(),
    explanation: 'An ACE inhibitor that relaxes blood vessels, helping blood flow more easily and reducing the workload on your heart.',
    simpleExplanation: 'A medicine that helps lower your blood pressure by relaxing your blood vessels.',
  },
  {
    id: 'vitamin-d',
    name: 'Vitamin D3',
