          ...
          <GlassCard className="p-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                ...
                { label: t('sidebar.missions'), value: `${completedCount}/${activeMissions.length}`, color: 'from-[#CDB6EF] to-purple-400' },
              ].map((stat) => (
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-3 sm:p-5 lg:p-8">
          <div className="max-w-6xl mx-auto space-y-4 sm:space-y-5 lg:space-y-7">
            <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-br from-[#013DC4] via-[#0150FF] to-[#4B7BE5] shadow-xl shadow-[#013DC4]/20">
              ...
              <div className="relative z-10 px-2 sm:px-3 pb-2 sm:pb-3">
                <div className="grid grid-cols-4 gap-1.5 sm:gap-2">
                  <Link href="/leaderboard" className="block">
                    <div className="bg-white/15 hover:bg-white/25 backdrop-blur-sm rounded-xl sm:rounded-2xl p-2 sm:p-3 transition-all cursor-pointer group">
                      <div className="flex flex-col items-center text-center gap-1">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-gradient-to-br from-yellow-300 to-amber-400 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                          <Zap className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                        </div>
                        <div className="text-sm sm:text-lg font-black text-white">{xp.toLocaleString()}</div>
                        <div className="text-[9px] sm:text-xs text-white/70 font-semibold">{t('sidebar.totalXp', 'Total XP')}</div>
                      </div>
                    </div>
                  </Link>
                  ...
                  <Link href="/streak" className="block">
                    <div className="bg-white/15 hover:bg-white/25 backdrop-blur-sm rounded-xl sm:rounded-2xl p-2 sm:p-3 transition-all cursor-pointer group">
                      <div className="flex flex-col items-center text-center gap-1">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-gradient-to-br from-orange-400 to-red-500 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                          <Flame className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                        </div>
                        <div className="text-sm sm:text-lg font-black text-white">{streak}d</div>
                        <div className="text-[9px] sm:text-xs text-white/70 font-semibold">{t('sidebar.streakLabel', 'Streak')}</div>
                      </div>
                    </div>
                  </Link>
                  ...
                  <Link href="/missions" className="block">
                    <div className="bg-white/15 hover:bg-white/25 backdrop-blur-sm rounded-xl sm:rounded-2xl p-2 sm:p-3 transition-all cursor-pointer group">
                      <div className="flex flex-col items-center text-center gap-1">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-gradient-to-br from-[#CDB6EF] to-purple-500 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                          <Target className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                        </div>
                        <div className="text-sm sm:text-lg font-black text-white">{completedCount}/{activeMissions.length}</div>
                        <div className="text-[9px] sm:text-xs text-white/70 font-semibold">{t('sidebar.missions', 'Missions')}</div>
                      </div>
                    </div>
                  </Link>
                  ...
                  <Link href="/leaderboard" className="block">
                    <div className="bg-white/15 hover:bg-white/25 backdrop-blur-sm rounded-xl sm:rounded-2xl p-2 sm:p-3 transition-all cursor-pointer group">
                      <div className="flex flex-col items-center text-center gap-1">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                          <Trophy className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                        </div>
                        <div className="text-sm sm:text-lg font-black text-white">{userAchievements?.filter(a => a.unlocked).length || 0}</div>
                        <div className="text-[9px] sm:text-xs text-white/70 font-semibold">{t('sidebar.achievements', 'Achievements')}</div>
                      </div>
                    </div>
                  </Link>
                </div>
