...
const localizations = {
  ...
  de: {
    ...
    subtitle: 'Hilf uns, Loretta zu verbessern',
    category: 'Kategorie',
    categories: {
    ...
    subject: 'Betreff',
    subjectPlaceholder: 'Kurze Zusammenfassung deines Feedbacks',
    message: 'Nachricht',
    messagePlaceholder: 'Erzähl uns mehr Details...',
    send: 'Feedback senden',
    sending: 'Wird gesendet...',
    error: 'Fehler',
    errorDescription: 'Bitte fülle alle erforderlichen Felder aus',
