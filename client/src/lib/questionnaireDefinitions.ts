import { Activity, AlertTriangle, Briefcase, Clock, DollarSign, Ear, GraduationCap, Heart, Home, Moon, Pill, Ruler, Scale, Smile, Stethoscope, TrendingUp, User, Video, Wine } from 'lucide-react';
...
export const baseQuestions: Question[] = [
  ...
  // 2. High blood pressure - Major clinical signal (gain: 93.7)
  {
  ...
  // 3. General health - Strong predictor (gain: 81.0)
  {
    id: 'general_health',
    apiId: 'HUQ010',
  ...
  // 4. Age - Important demographic (gain: 46.6)
  {
    id: 'age',
    apiId: 'RIDAGEYR',
  ...
  // 5. Weight - For BMI calculation (gain: 21.9)
  {
    id: 'weight_current',
    apiId: 'WHD020',
  ...
  // 6. Height - For BMI calculation (gain: 11.4)
  {
    id: 'height',
    apiId: 'WHD010',
  ...
  // 7. High cholesterol - Metabolic marker (gain: 72.2)
  {
    id: 'high_cholesterol',
    apiId: 'BPQ080',
...
export function getQuestionOptions(id: string): QuestionOption[] | undefined {
  const question = getQuestionById(id);
...
export function getQuestionsByModule(module: 'core' | 'medical' | 'lifestyle' | 'oral' | 'financial'): Question[] {
